...
namespace CustomerOrderManagement.API.Helpers
{
    ...
    {
        public string UserId => HttpContext.Current?.User?.Identity?.IsAuthenticated == true
                ? HttpContext.Current.User.Identity.Name
                : null;

        public string UserName => HttpContext.Current?.User?.Identity?.IsAuthenticated == true
                ? HttpContext.Current.User.Identity.Name
                : null;
